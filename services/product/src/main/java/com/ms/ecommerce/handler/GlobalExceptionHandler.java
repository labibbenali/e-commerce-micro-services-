...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<String> handleCustomerNotFoundException(ProductPurchaseExecption exp) {
    ...
    public ResponseEntity<ErrorResponse> handleMethodeArgException (MethodArgumentNotValidException exp) {
